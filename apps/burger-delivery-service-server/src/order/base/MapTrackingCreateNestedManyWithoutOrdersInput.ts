...
@InputType()
class MapTrackingCreateNestedManyWithoutOrdersInput {
...
export { MapTrackingCreateNestedManyWithoutOrdersInput as MapTrackingCreateNestedManyWithoutOrdersInput };
