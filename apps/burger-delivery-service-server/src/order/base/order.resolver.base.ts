...
export class OrderResolverBase {
  ...
  async createOrder(@graphql.Args() args: CreateOrderArgs): Promise<Order> {
    return await this.service.createOrder({
      ...
      data: {
        ...
        burger: args.data.burger
          ? {
              connect: args.data.burger,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => [MapTracking], { name: "mapTrackings" })
  async findMapTrackings(
    @graphql.Parent() parent: Order,
    @graphql.Args() args: MapTrackingFindManyArgs
  ): Promise<MapTracking[]> {
    const results = await this.service.findMapTrackings(parent.id, args);
  ...
  @graphql.ResolveField(() => Burger, {
    nullable: true,
    name: "burger",
  })
  async getBurger(@graphql.Parent() parent: Order): Promise<Burger | null> {
    const result = await this.service.getBurger(parent.id);
  ...
  @graphql.ResolveField(() => Delivery, {
    nullable: true,
    name: "delivery",
  })
  async getDelivery(@graphql.Parent() parent: Order): Promise<Delivery | null> {
